        ...
        $(document).ready(function() {
            $("#form-edit").validate({
                rules: {
                    ...
                    supplier_id: { required: true, number: true }, // Tambah validasi supplier
                ...
                submitHandler: function(form) {
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            var errorMessage = xhr.responseJSON ? xhr.responseJSON.message : "Terjadi kesalahan pada server.";
                            Swal.fire({ icon: 'error', title: 'Error Server', text: errorMessage });
                        }
                    });
                    return false;
                },
